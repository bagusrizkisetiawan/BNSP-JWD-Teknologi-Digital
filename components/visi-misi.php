<div id="visi" class="py-5 bg-light">
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-5">
                ...
                <ul class="text-secondary" data-aos="fade-up">
                    ...
                    <li>
                        Mengutamakan Pelanggan: Menempatkan kepuasan pelanggan sebagai prioritas utama dengan menyediakan layanan yang responsif, handal, dan personal.
                    </li>
                    <li>
                        Mendorong Inovasi: Terus berinovasi dan mengikuti perkembangan teknologi terbaru untuk memberikan solusi yang modern dan relevan.
                    </li>
                </ul>
            </div>
            <div class="col-lg-6">

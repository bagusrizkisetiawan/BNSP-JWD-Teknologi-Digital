<div id="produk" class="py-5">
    <div class="container-fuild py-5 px-3 ">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-secondary">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio illo perferendis minima unde quos obcaecati.
                        </p>
                        <a href="" class="btn btn-sm btn-primary px-4 p-2">See Project</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
